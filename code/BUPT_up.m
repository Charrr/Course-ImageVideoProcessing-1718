...
%   Input:
%       IN: input matrix
%       interpolate:  'n' for nearest neighbour, 'b' for bilinear, 'both'
%       for showing both for comparison
